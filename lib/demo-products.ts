...
const rawDemoProducts: Omit<Product, "description">[] = [
  ...
  { id: "demo-dojo-600", name: "600 Blue Razz", brand: "Dojo", category: "vapes", sku: "DJ6-BLRA", packLabel: "Box of 10", unitsPerPack: 10, unitPrice: 3.2, casePrice: 32.0 },
  { id: "demo-dojo-800", name: "800 Watermelon", brand: "Dojo", category: "vapes", sku: "DJ8-WAT", packLabel: "Box of 10", unitsPerPack: 10, unitPrice: 3.4, casePrice: 34.0 },
  { id: "demo-hayati-pro", name: "Pro Fresh Mint", brand: "Hayati", category: "vapes", sku: "HYP-MINT", packLabel: "Box of 10", unitsPerPack: 10, unitPrice: 3.95, casePrice: 39.5, badge: "Popular" },
  { id: "demo-hayati-promax", name: "Pro Max Cherry Cola", brand: "Hayati", category: "vapes", sku: "HYPM-CHCO", packLabel: "Box of 10", unitsPerPack: 10, unitPrice: 4.15, casePrice: 41.5 },
